					...
					<div className="w-full max-w-3xl mx-auto">
							...
							{searchTabs.map((tab) => (
								<button
									...
									className={cn(
										...
										"hover:text-primary",
										activeTab === tab.id ? "border-b-2 border-primary" : "border-b-2 border-transparent"
									)}
								>
									{tab.label}
								</button>
						...
						<div className="relative">
							<input
								...
								className="bg-white w-full px-6 py-4 pr-12 text-lg rounded-full border-2 border-primary focus:outline-hidden focus:ring-2 focus:ring-primary focus:border-transparent"
							/>
							<button className="absolute right-4 top-1/2 -translate-y-1/2 p-2 rounded-full bg-primary text-white hover:bg-[#ff5a13] transition-colors">
