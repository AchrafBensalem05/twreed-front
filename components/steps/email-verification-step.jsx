	...
	return (
		<div className="space-y-6 w-full max-w-sm">
			...
			<div className="space-y-2">
				...
				<p className="text-sm text-muted-foreground">Enter the verification code we emailed to:</p>
				<p className="text-sm font-medium">{data.email}</p>
				<button className="text-sm text-orange-500 hover:text-orange-600" onClick={resetEmail}>
			...
			<Form {...form}>
				<form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
					...
					/>
					<Button type="submit" className="w-full bg-orange-500 hover:bg-orange-600" disabled={loading || !form.watch("otp") || form.watch("otp").length !== 6}>
